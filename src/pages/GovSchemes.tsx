...
import { ArrowRight, CheckCircle2, FileText, Landmark, RefreshCw, Search, Sparkles } from 'lucide-react';
              ...
              >
                <GlassCard hoverEffect className="flex flex-col h-full">
                  ...
                  <div className="space-y-2.5 mb-5 flex-grow">
                    ...
                    {!scheme.max_amount && scheme.loan_amount && (
                      <div className="flex justify-between text-sm">
                        <span className="text-slate-400">Loan Amount</span>
                        <span className="font-medium text-white text-right max-w-[55%]">{scheme.loan_amount}</span>
                      </div>
                    )}
